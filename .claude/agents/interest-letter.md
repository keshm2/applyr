...
model: inherit
---
<!-- GENERATED from agents/bodies/interest-letter.md + agents/frontmatter/claude/interest-letter.yaml — edit those sources and run scripts/validate/generate_agent_definitions.py -->
